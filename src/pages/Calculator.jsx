...
import { DollarSign, ChevronDown, Plus, Minus, Sparkles, RotateCcw } from 'lucide-react';
...
const evaluateExpression = (expression) => {
  ...
  try {
    ...
    return Math.max(0, parseInt(expression) || 0);
  }
};
...
export default function CalculatorPage() {
  ...
  const handleQuantityChange = (itemName, value) => {
    ...
    // Auto-compute and update quantities in real-time
    if (value === '' || value === null || value === undefined) {
      ...
      // Evaluate the expression immediately as user types
  ...
  const handleQuantityBlur = (itemName) => {
    ...
    if (value === '') {
      // Keep input empty, quantity already set to 0
      return;
    }
    ...
    setInputValues(prev => ({
      ...prev,
      [itemName]: evaluatedValue > 0 ? evaluatedValue.toString() : ''
    }));
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Single Draggable Total Bar - Shows on scroll for desktop, always visible on mobile */}
        <div 
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <input
                                ...
                                className="flex-1 text-center text-base sm:text-lg font-bold text-slate-900 bg-white border-2 border-slate-300 rounded-lg py-1.5 sm:py-2 px-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="0"
                              />
